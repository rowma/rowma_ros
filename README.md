## rowma_ros (melodic) - 0.0.2-2

The packages in the `rowma_ros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release --rosdistro melodic --track melodic rowma_ros` on `Sun, 12 Apr 2020 13:54:57 -0000`
